...
public class TopicNameMapper {
    ...
    private String environment;// Map for custom topic name mappings
    ...
    public TopicNameMapper() {
        ...
        topicNameMappings.put("Order.OrderConfirmedIntegrationEvent",
                "order-confirmed");
     ...
     * @param eventType     the type of event (e.g.,
    ...
    public String mapToTopicName(String aggregateType, String eventType) {
        ...
        String defaultTopicName = aggregateType.toLowerCase() + "-" +
                eventType.replace("IntegrationEvent",
                        "").toLowerCase();
